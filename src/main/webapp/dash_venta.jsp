                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 mx-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
        <form>
            <!-- Fila 1: DNI Cliente, Cliente -->
            <div class="row mb-3">
                <div class="col-lg-4">
                    <label for="dniCliente">DNI Cliente:</label>
                    <div class="input-group">
                        <input type="text" id="dniCliente" class="form-control" placeholder="123">
                        <button class="btn btn-secondary">Buscar</button>
                    </div>
                </div>
                <div class="col-lg-8">
                    <label for="cliente">Cliente:</label>
                    <input type="text" id="cliente" class="form-control" value="Cliente Frecuente" readonly>
                </div>
            </div>

            <!-- Fila 2: Código Producto, Producto, Precio, Stock -->
            <div class="row mb-3">
                <div class="col-lg-2">
                    <label for="codigoProducto">Cod. Producto:</label>
                    <div class="input-group">
                        <input type="text" id="codigoProducto" class="form-control" placeholder="2">
                        <button class="btn btn-secondary">Buscar</button>
                    </div>
                </div>
                <div class="col-lg-4">
                    <label for="producto">Producto:</label>
                    <input type="text" id="producto" class="form-control" value="Mouse Inalámbrico Logitech" readonly>
                </div>
                <div class="col-lg-3">
                    <label for="precio">Precio Producto:</label>
                    <input type="text" id="precio" class="form-control" value="20.0">
                </div>
                <div class="col-lg-2">
                    <label for="stock">Stock:</label>
                    <input type="text" id="stock" class="form-control" value="44" readonly>
                </div>
            ...
            <!-- Fila 3: Cantidad, Fecha, Vendedor -->
            <div class="row mb-3">
                <div class="col-lg-3">
                    <label for="cantidad">Cantidad Prod.:</label>
                    <input type="number" id="cantidad" class="form-control" value="1">
                </div>
                <div class="col-lg-3">
                    <label for="fecha">Fecha:</label>
                    <input type="date" id="fecha" class="form-control" value="2019-03-21">
                </div>
                <div class="col-lg-6">
                    <label for="vendedor">Vendedor:</label>
                    <input type="text" id="vendedor" class="form-control" value="Empleado 0001" readonly>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <strong class="me-2">Total a Pagar:</strong>
                    <span class="border px-3 py-1">$0.00</span>
                </div>
            </div>
        </form>
                                </div>
